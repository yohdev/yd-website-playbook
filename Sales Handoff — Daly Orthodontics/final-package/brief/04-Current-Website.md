---
file: Current Website
source: Domain + /sitemap.xml crawl
owner: sales
last_updated: 2026-04-24
---

# Current Website — Daly Orthodontics
...
| Last redesigned | {{unknown — ask in Phase 01}} |
| Est. monthly visitors | {{unknown — ask in Phase 01}} |

---
## Nav observed on current site (2026-04-24 screenshot)
Primary nav (desktop): **Welcome · About · Treatments · New Patients · Patient Hub · More**
Primary CTA: **Schedule Now** (top-right, cream-pill treatment)
Persistent side tabs (right edge): **Virtual Consultation**, **Book Appointment** (mustard-yellow, reads as third-party widget)
Bottom-right floating element: scheduling widget (appears to be LocalMed-style orthodontic booking)
Bottom-left: accessibility widget

---
## Pages in scope (confirmed from nav + discovery, granular pages TBD in Phase 02 crawl)
| Page | Path | Priority |
|---|---|---|
| Home / Welcome | / | High |
...
- **Analytics:** {{unknown — ask in Phase 01}}
- **CRM embed:** {{unknown — ask in Phase 01}}
- **Forms:** {{unknown — confirm in Phase 02 crawl; likely a contact/booking form present}}
- **Chat:** {{unknown — ask in Phase 01}}
- **Google Ads:** Active campaigns running — landing page continuity must be preserved during migration to avoid disrupting paid traffic
- **Other:** {{unknown — ask in Phase 01}}

---
## Sitemap snapshot
> Complete during Phase 02 Research — crawl https://dailyorthodontics.com/sitemap.xml
>
> Pay particular attention to blog post URLs and any service or location pages that may carry backlink equity. All URLs with meaningful organic ranking must be mapped one-for-one before migration begins.

---
## What's working (keep it)
- Existing Google search rankings and backlink equity — must be fully preserved through one-for-one URL and content structure migration
- Existing proprietary practice photography currently on the site — assets must be exported and transferred to client ownership
...
- Blog content strategy misaligned with practice specialty and target audience (Burlington, NC orthodontic patients)